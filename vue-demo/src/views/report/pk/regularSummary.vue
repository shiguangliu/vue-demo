  ...
  <div class="app-container">
    ...
    >
      <el-table-column
        ...
        width="150"
      />
      <el-table-column label="常规路赛PK场次">
        <el-table-column
          prop="session1"
          label="用户&用户"
          align="right"
      ...
      <el-table-column
        ...
        align="right"
      />
      <el-table-column label="常规路赛PK胜率（%）">
        <el-table-column
          prop="winRate1"
          label="用户"
          align="right"
...
import { getReportPkRegularSummary } from '@/api/report/pk'
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      this.loading = true
      this.$handleAPI('', getReportPkRegularSummary, this.filterInfo.query).then(
        res => {
          if (res.code === 200) {
